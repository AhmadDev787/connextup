...
const cards = [
  {
    title: "01 / SEGMENTAZIONE DELL'AUDIENCE",
    icon: Settings2,
    text: [
  ...
  {
    title: "02 / OTTIMIZZAZIONE DEI CREATIVE E DEL FORM",
    icon: ClipboardCheck,
    text: [
  ...
  {
    title: "03 / FEEDBACK LOOP SUI DATI",
    icon: RefreshCcw,
    text: [
    ...
    <>
      ...
      <section className=" py-20">
        <div className="mx-auto max-w-7xl px-5 text-center">
          ...
          >
            In un mercato dove tutti competono sullo stesso budget e sulle
            stesse audience, la vera leva non è spendere di più: è spendere
            meglio.
          </motion.h2>
        </div>
      </section>
