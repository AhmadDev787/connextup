...
import { empara } from "../../../components/paths.json";
export default function Hero() {
  return (
    <section className="relative h-[100vh] overflow-hidden">
      <Image src={empara} alt="empara" fill priority className="object-cover" />
      ...
      >
        <section className="mx-auto container px-6 w-full">
          <Image
            ...
            width={350}
            alt="empara's logo"
            className=" h-[70px] md:h-[100px] w-[170px] md:w-[250px]"
          />
        </section>
