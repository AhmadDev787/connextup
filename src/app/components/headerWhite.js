...
export default function HeaderWhite() {
  ...
  return (
    <motion.header
      ...
      className="fixed text-white top-0 left-0 w-full z-[100]"
    >
      ...
      <div className="container mx-auto flex items-center justify-between p-4">
          ...
          {navLinks.map((link, i) => {
            ...
            return (
              <motion.span key={i} whileHover={{ y: -2 }}>
                <Link
                  href={link.href}
                  className={`flex items-center font-normal gap-1 transition-colors ${
        ...
        {/* Mobile Hamburger */}
        <button
          className="md:hidden text-white hover:text-cu-blue transition"
        ...
        {menuOpen && (
          ...
          >
            ...
            <div className="flex justify-end">
              <button
                className="text-[#E0E0E0] hover:text-cu-green"
